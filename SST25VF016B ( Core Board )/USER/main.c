...
**--------------File Info---------------------------------------------------------------------------------
** File name:               main.c
** Descriptions:            This example describes how to use SST25VF016B (Core) functionality on SPI of LPC1788
**
**--------------------------------------------------------------------------------------------------------
** Created by:              AVRman
...
int main(void)
{
	...
	{	
		_DBG_("HY-LPC1788-Core SPI Flash SST25VF016B Read ID False");
    }
	...
	{
		_DBG_("HY-LPC1788-Core SPI Flash SST25VF016B OK");
	}
	else
	{
		_DBG_("HY-LPC1788-Core SPI Flash SST25VF016B False");
	}
