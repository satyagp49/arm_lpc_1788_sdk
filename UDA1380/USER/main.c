...
extern int32_t Uda1380_Init(uint32_t i2cClockFreq, uint32_t i2sClockFreq);
...
void Buffer_Init(void)
{
   debug_frmwrk_init();
    ...
    memcpy(&userWav,audio,sizeof(WavHeader));
}
